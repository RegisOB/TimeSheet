...
\documentclass[a4paper,12pt,oneside, landscape]{article}\usepackage[]{graphicx}\usepackage[]{color}
...
%' library(xtable)
%' tab1 <- xtable((TableProgram.2), digits=0)
%' #align(tab1) <- as.character(|l|*{(ncol(TableProgram.2)-1)}{c|})
%' print(tab1, latex.environments = "center")
%' @
%' 
%' %%Print absence table
%' %%%%%%%%%%%%%%%%%%%%%%
%' <<tab2,results='asis',echo=FALSE>>=
%' tab2 <- xtable((TableAbsence.2), digits=0)
%' #align(tab1) <- as.character(|l|*{(ncol(TableProgram.2)-1)}{c|})
%' print(tab2, latex.environments = "center", include.colnames = FALSE, hline.after = c(0,nrow(tab2)))
%' @
%' 
%' %%Print total productive hours table
%' %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%' <<tab3,results='asis',echo=FALSE>>=
%' tab3 <- xtable((TotProd_Hr), digits=0)
%' #align(tab1) <- as.character(|l|*{(ncol(TableProgram.2)-1)}{c|})
%' print(tab3, latex.environments = "center", include.colnames = FALSE, hline.after = c(0,nrow(tab3)))
%' @
%' 
%' %%Print total hours table
%' %%%%%%%%%%%%%%%%%%%%%%%%%
%' <<tab4,results='asis',echo=FALSE>>=
%' tab4 <- xtable((Tot_Hrs.2), digits=0)
%' #align(tab1) <- as.character(|l|*{(ncol(TableProgram.2)-1)}{c|})
%' print(tab4, latex.environments = "center", include.colnames = FALSE, hline.after = c(0,nrow(tab3)))
%' @

% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Fri Feb 26 18:45:51 2016
\begin{table}[ht]
\centering
